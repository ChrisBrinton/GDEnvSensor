...
void wifiSetup() {
    ...
    jw.onMessage([](justwifi_messages_t code, char * parameter) {
		    ...
		    if (code == MESSAGE_CONNECTED) {
		        ...
		        DEBUG_MSG("[WIFI] ----------------------------------------------\n");
            displayWifiInfo((char*)"Conn:", (char*)WiFi.SSID().c_str(), (char*)WiFi.localIP().toString().c_str());
		    }
		    ...
		    if (code == MESSAGE_ACCESSPOINT_CREATED) {
		        ...
		        DEBUG_MSG("[WIFI] ----------------------------------------------\n");
            displayWifiInfo((char*)"AP:", (char*)jw.getAPSSID().c_str(), (char*)WiFi.softAPIP().toString().c_str());
		    }
